# -*- coding: utf-8 -*-
"""WSGI middleware initialization for the pegasus application."""

from pegasus.config.app_cfg import base_config
from pegasus.config.environment import load_environment
